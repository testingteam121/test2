...
window.replayGameEvent = function() {
    ...
    gameInstance.SendMessage('UIManager', 'ReplayGameEvent', 'replay');
}
...
window.enableSound = function(isenabled) {
    ...
    if (isenabled)
    {
        gameInstance.SendMessage('HomeManager', 'ToggleMusicEventOn', 'on');
        gameInstance.SendMessage('UIManager', 'ToggleMusicEventOn', 'on');

    }
    else
    {
        gameInstance.SendMessage('HomeManager', 'ToggleMusicEventOff', 'off');
        gameInstance.SendMessage('UIManager', 'ToggleMusicEventOff', 'off');

    }

    if (isenabled)
    {
        gameInstance.SendMessage('HomeManager', 'ToggleSoundEventOn', 'on');
        gameInstance.SendMessage('UIManager', 'ToggleSoundEventOn', 'on');
    }
    else
    {
        gameInstance.SendMessage('HomeManager', 'ToggleSoundEventOff', 'off');
        gameInstance.SendMessage('UIManager', 'ToggleSoundEventOff', 'off');
    }
}
